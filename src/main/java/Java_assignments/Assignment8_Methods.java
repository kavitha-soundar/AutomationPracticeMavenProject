...
public class Assignment8_Methods {
	...
	public static String hikeAmount(String Salary,String experience, String yearEndRating)
	{
		...
		Float rating = Float.parseFloat(yearEndRating);
		int exp = Integer.valueOf(experience);
		int baseSalary =  Integer.valueOf(Salary);
